...
import { TrendingUp, TrendingDown, Clock, MoreHorizontal, Copy, FileText, AlertCircle } from 'lucide-react';
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="relative" ref={dropdownRef}>
                        ...
                        {openDropdown === order.id && (
                          <div className="absolute right-0 mt-1 w-48 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-md shadow-lg z-10">
                            <div className="py-1">
                              <button
                                onClick={() => {
...
Status: ${order.status}
Created: ${formatSafeDate(order.createdAt)}`;
